  ...
  useEffect(() => {
    if (product) {
      ...
      const priceInCurrentCurrency =
        priceInILS > 0 ? convertFromILSSync(priceInILS, currency) : 0;

      setForm({
        name: product.name || "",
        description: product.description || "",
        price:
          priceInCurrentCurrency > 0 ? priceInCurrentCurrency.toFixed(2) : "",
        stock: product.stock || "",
        image: product.image || "",
