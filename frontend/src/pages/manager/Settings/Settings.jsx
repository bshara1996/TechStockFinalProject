...
const Settings = () => {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        const fetchedSettings = Array.isArray(settingsRes.data)
          ? settingsRes.data[0]
          : settingsRes.data;
  ...
  useEffect(() => {
    ...
    if (
      contextCurrency !== previousSettingsRef.current.currency ||
  ...
  return (
    <div className="settings-container">
      <div className="settings-header">
        <h1>
          <IoSettingsSharp color="#363636b7" /> Settings
        </h1>
