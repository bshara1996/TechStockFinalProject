...
const Categories = () => {
  ...
  const [editedCategoryImagePreview, setEditedCategoryImagePreview] =
    useState(null);
    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          showError(
            err.response?.data?.message || "Failed to toggle category status."
          );
        }
      },
      () => {
    ...
    <div className="categories-container">
      <div className="categories-header">
        <h1 className="categories-title">
          <RiBox3Fill color="#363636b7" /> Manage Categories
        </h1>
            ...
            <table className="categories-table">
              <thead>
                <tr>
                  ...
                  <th
                    className={`sortable status-cell ${
                      sortConfig.field === "status" ? "active" : ""
                    }`}
            ...
            <form onSubmit={handleUpdateCategory} className="modal-form">
              ...
              <div className="form-group">
                ...
                {editedCategoryImagePreview && (
                  <div className="image-preview-container">
                    <img
                      src={editedCategoryImagePreview}
                      alt="Category Preview"
                      className="image-preview"
                    />
                  </div>
