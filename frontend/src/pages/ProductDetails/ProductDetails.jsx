...
import { FaArrowLeft, FaShare, FaShoppingCart, FaSearch } from "react-icons/fa";
  ...
  useEffect(() => {
    async function fetchProduct() {
      ...
      try {
        ...
        // If API returned empty or invalid product, mark as not found
        if (!data || Object.keys(data).length === 0 || !data.product_id) {
          setProduct(null);
          setNotFound(true);
        } else {
          setProduct(data);
    ...
    <div className="product-details-container">
      ...
      <div className="product-header-nav">
        <div className="header-nav-content">
          <button onClick={() => navigate(-1)} className="back-button-nav">
            <FaArrowLeft /> Back to Products
          </button>
        </div>
      </div>
      ...
      <div className="product-main-container">
        ...
        <div className="product-info-column">
          ...
          {/* Stock Status */}
          <div
            className={`stock-status-container ${
              stockColor === "#28a745"
            ...
            {cartMsg && (
              <div
                className={`cart-message ${
                  cartMsg.includes("Added") ? "success" : "error"
                }`}
              >
                {cartMsg}
              </div>
          ...
          <div className="specifications-section">
            <h3 className="specifications-title">Product Information</h3>
