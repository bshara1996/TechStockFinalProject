        ...
        <div className="order-summary-card">
          ...
          {discountAmount > 0 && (
            <div className="summary-item">
              ...
              <span>
                {formatPriceConverted(subtotalAfterDiscount, currency)}
              </span>
            </div>
          )}
          <div className="summary-item">
          ...
          {paymentMethod === "paypal" && (
            <div className="paypal-container">
              <div className="paypal-payment-info">
                <p>
                  PayPal payment for: {formatPriceConverted(total, currency)}
                </p>
              </div>
              ...
              <PayPalButtons
                createOrder={async (data, actions) => {
                  ...
                  const convertedTotal = await convertFromILS(
                    total,
                    currency || "ILS"
                  );
                  ...
                  const paypalAmount =
                    Math.round((convertedTotal + Number.EPSILON) * 100) / 100;
